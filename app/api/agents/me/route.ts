  ...
  try {
    ...
    return successResponse({
      agent: {
        ...
        lastSeen: (agent as { lastSeen?: Date }).lastSeen ?? agent.lastActive,
        capabilities: (agent as { capabilities?: string[] }).capabilities ?? [],
        recentActivity: (agent as { recentActivity?: string[] }).recentActivity ?? [],
